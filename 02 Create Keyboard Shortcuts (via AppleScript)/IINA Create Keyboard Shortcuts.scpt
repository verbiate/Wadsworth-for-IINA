(*
	Set shortcuts for Wadsworth (Jump to N% for IINA)

	Requires Assistive Device access in order to run.
	Also requires Wadsworth for IINA Automator scripts to be installed. 
	See this link for details:
	https://github.com/verbiate/Wadsworth-for-IINA
*)
	...
	tell application process "System Preferences"
		...
		tell window 1
			...
			repeat while i < 10
				...
				if i is 0 then
					keystroke "IINA Jumping to " & i & "%"
				else
					keystroke "IINA Jumping to " & i & "0%"
				end if
				keystroke tab
				key down command
				key down option
